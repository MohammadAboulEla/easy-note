export namespace main {
	...
	export class AiBehavior {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.commands = this.convertValues(source["commands"], AiCommand);
	    }
	...
	export class Settings {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.ai = this.convertValues(source["ai"], AiBehavior);
	    }
